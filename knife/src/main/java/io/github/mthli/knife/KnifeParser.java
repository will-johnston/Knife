...
public class KnifeParser {
    public static Spanned fromHtml(String source, KnifeText knife, Drawable placeholder) {
        return Html.fromHtml(source, new KnifeImageGetter(knife, placeholder), new KnifeTagHandler());
    }
